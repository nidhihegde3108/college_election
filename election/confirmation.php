...
<body>
  ...
  ?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6" >
                ...
                <tr>
                        ...
                        <td class="td-1"><input   required type="number" style="text-align: left;" name="txtRollNo" value="$usn"></td>
                    </tr>
                    <tr>
        ...
        $sql = "select name from candidates where approve_status=1 and pname='president'";
