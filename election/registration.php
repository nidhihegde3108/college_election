...
.container h1{
	...
	margin-bottom: 30px;
	color: whitesmoke;
	text-decoration: underline #5f1178 10px;
}
.tbox{
	width: 260px;
	height: 40px;
			...
			<?php
              ...
              ?>
				<form name="sign-up" action="" method="post"
					...
					<i class="fa fa-key" style="font-size:80px;color:#5f1178; margin-left: 5px;"></i>
                    ...
                    <div class="row">
						<div class="inline-block">
							...
							<input class="input-box-330 tbox" type="text" name="student_name"
								id="student_name" placeholder="Name">
						</div>
					</div>
                    <div class="row">
						<div class="inline-block">
                    ...
                    <div class="row">
						<div class="inline-block">
							...
							<input class="input-box-330 tbox" type="email" name="email" id="email" placeholder="Email">
						</div>
					</div>
					
					</div>
					<div class="row">
						<input class="btn btn-dark button" type="submit" name="signup-btn"
